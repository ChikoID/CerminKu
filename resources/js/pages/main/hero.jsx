...
export default function Hero() {
    return (
        <>
            ...
            <section id="home" className="scroll-mt-20 flex flex-col items-center justify-center w-full px-6 gap-4">
                <div className="flex flex-col items-center justify-center gap-4 w-full">
                    ...
                    <Link className="bg-primary-800 hover:bg-secondary-800 shadow px-4 py-2 rounded-full font-semibold text-white">
                        Mulai Sekarang
                    </Link>
                </div>
                <div className="grid grid-cols-5 justify-items-center items-center">
                    <div className="flex flex-col items-start w-full gap-4">
                        ...
                        <p className="text-primary-800 text-base text-justify leading-relaxed">
                            Kadang, diam bukan berarti nggak peduli tapi karena
                            hati lagi belajar bicara dengan cara yang beda. Di
                            saat seperti itu, kehadiran yang hangat bisa lebih
                    ...
                    <div className="text-primary-800 flex flex-col items-start w-full gap-4">
                        <div className="flex flex-col gap-4 text-secondary-800">
                            <h2 className="font-bold text-lg leading-relaxed">Motivasi :</h2>
                        ...
                        <div className="flex flex-col gap-2 mt-10">
                            ...
                            <form className="flex flex-col   gap-2 justify-center">
                                ...
                                />
                                <button className="bg-primary-800 text-white px-4 py-2 rounded-full hover:bg-secondary-800">
                                    Kirim
                                </button>
                            </form>
                        </div>
